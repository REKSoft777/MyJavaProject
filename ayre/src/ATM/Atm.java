...
public class Atm {
	...
	private final Path FILE=Paths.get("ATM.txt");
	private final JFrame frame=new JFrame("ATM Machine");
	private String saveFile;
	private String[] split;
	private final JLabel text = new JLabel("Welcome to Societe ATM! What action would you like to make today?");
	...
	private int username, balance, password, usernameIndex;
	private boolean isRegister, isDepositing,used;
	...
	private void loginScreen() {
		...
		private void startScreen() {
	        ...
	        password = 0;
	        balance = 0;
	        text.setText("Welcome to Société ATM! What action would you like to make today?");
